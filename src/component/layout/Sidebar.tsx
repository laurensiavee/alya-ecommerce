        ...
        <aside id="default-sidebar" className="fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-l-text">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <a onClick={() => router.push('/add-promotion')} className="flex items-center p-2 text-d-text rounded-lg hover:bg-l-text-secondary group ">
                ...
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <a onClick={() => router.push('/add-product-category')} className="flex items-center p-2 text-d-text rounded-lg hover:bg-l-text-secondary group ">
